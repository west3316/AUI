...
extern int SDL_DrawPolygon(SDL_Surface *sfc, const SDL_Point2 *vertices, int nVertices, Uint32 colour);
extern int SDL_FillPolygon(SDL_Surface *sfc, const SDL_Point2 *vertices, int nVertices, Uint32 colour);
